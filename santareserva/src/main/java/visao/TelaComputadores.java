...
public class TelaComputadores extends JFrame {
	...
	public TelaComputadores(Hospedes hospede) {
		...
		lblNewLabel_5.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				TelaReservas c = new TelaReservas(hospede, hospede, null, null, null, compSelecionado);
				c.setVisible(true);
				dispose();
		...
		lblNewLabel_20.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				TelaReservas telaReservas = new TelaReservas(hospede, hospede, null, null, null, compSelecionado);
