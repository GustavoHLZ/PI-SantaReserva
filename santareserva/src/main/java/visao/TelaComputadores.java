...
public class TelaComputadores extends JFrame { 
	...
	public TelaComputadores(Hospedes hospede, Quartos quarto, ArrayList<Quartos> listaQuartos,SalaReunioes salareunioes, ArrayList<Computadores> listaComputadores, Computadores computador, ArrayList<SalaReunioes> listaSalas) { 
		...
		lblNewLabel.setIcon(new ImageIcon(TelaComputadores.class.getResource("/visao/Icones/LogoCerta2.png"))); 
		...
		table.addMouseListener(new MouseAdapter() { 
			...
			public void mouseClicked(MouseEvent e) { 
				if (e.getClickCount() == 1) { 
		            ...
		            if (posicaoComp != -1) { 
		            	computadoralugado = listarComputadores.get(posicaoComp); 
		            } 
		        } 
	...
	protected void atualizarJTable() { 
	    ...
	    ComputadoresDAO CompDAO = ComputadoresDAO.getInstancia(); 
	    listarComputadores = CompDAO.listarComputadores(); 
	    		 
	    for (int i = 0; i < listarComputadores.size(); i++) { 
	        Computadores comp = listarComputadores.get(i); 
