...
public class TelaQuartos extends JFrame {
	...
	public TelaQuartos() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/LogoAPP.png")));
		PainelTopo.add(lblNewLabel_2, "cell 0 0");
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeUser.png")));
		...
		lblImagemHome.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeHome.png")));
		...
		lblImagemPerfil.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconePerfil.png")));
		...
		lblImagemReserva.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeReserva.png")));
		...
		lblImagemSalaReunioes.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeSalaReunioes.png")));
		...
		lblImagemComputador.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeComputadores.png")));
		...
		lblImagemQuarto.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeQuartos.png")));
		...
		lblImagemAvalie.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeAvalie.png")));
		...
		lblImagemNossasInfo.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeInformacoes.png")));
		...
		lblImagemConfig.setIcon(new ImageIcon(TelaQuartos.class.getResource("/visao/Icones/IconeConfiguracoes.png")));
		...
		PainelQuarto.setBackground(new Color(239, 239, 239));
		PainelGeral.add(PainelQuarto, "cell 11 6 55 30,grow");
		PainelQuarto.setLayout(new MigLayout("", "[grow]", "[grow]"));
		
		JPanel panel_21 = new JPanel();
		PainelQuarto.add(panel_21, "cell 0 0");
